...
function vanilla_scripts_styles(){
...
add_action('wp_enqueue_scripts','vanilla_scripts_styles');
...
// Custom template if category matches in single post
...
function custom_theme_features()  { add_editor_style(); }
